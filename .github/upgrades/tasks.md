...
### [ ] TASK-002: Update project files to .NET 10 (topological order)
...
### [ ] TASK-003: Update NuGet packages to version 10.0.0
**References**: Plan §Phase 3

- [ ] (1) Update all listed NuGet packages to 10.0.0 per Plan §Phase 3
- [ ] (2) Restore dependencies for all projects
- [ ] (3) Packages updated and restored (**Verify**)

### [ ] TASK-004: Build and test solution
**References**: Plan §Phase 4, Plan §Phase 5

- [ ] (1) Build each project incrementally per Plan §Phase 4
- [ ] (2) Run test suite in AsyncDemo.Tests project
- [ ] (3) Address any breaking changes identified during build/test (see Plan §Potential Breaking Changes)
- [ ] (4) Solution builds with 0 errors and all tests pass (**Verify**)
